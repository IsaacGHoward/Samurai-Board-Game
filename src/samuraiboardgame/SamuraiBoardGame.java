       ...
       private void createAndShowGUI()
	{
       ...
       public void checkEnd()
       {
           ...
           for(int i =0; i<BWIDTH; i++)
           {
                    for(int b=0; b<BHEIGHT; b++)
                    {
                        if(board[i][b] instanceof Terrain && ((Terrain)board[i][b]).getTerrainType() == Terrain.terrainType.land)
                            numTerrain++;
           ...
           {
               gameOver = true;
               System.out.println("GAMEOVERRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAARRRRRRRRRRRRRR");
           }
               ...
               for(int d=0;d<city.numCityResources; d++)
               {
                if(board[x-1][y] instanceof Piece)
                {
                         ...
                         ((Piece)board[x-1][y]).getPieceType() == Piece.pieceType.tileExchange)
                 {
                     ...
                     playerInfluence[((Piece)board[x-1][y]).getPlayer()-1][d] += ((Piece)board[x-1][y]).getValue();
                 }
                }
                if(board[x-1][y-1] instanceof Piece)
                {
                         ...
                         ((Piece)board[x-1][y-1]).getPieceType() == Piece.pieceType.tileExchange)
                 {
                     ...
                     playerInfluence[((Piece)board[x-1][y-1]).getPlayer()-1][d] += ((Piece)board[x-1][y-1]).getValue();
                 }
                }
                if(board[x][y+1] instanceof Piece)
                {
                         ...
                         ((Piece)board[x][y+1]).getPieceType() == Piece.pieceType.tileExchange)
                 {
                     ...
                     playerInfluence[((Piece)board[x][y+1]).getPlayer()-1][d] += ((Piece)board[x][y+1]).getValue();
                 }
                }
                if(board[x][y-1] instanceof Piece)
...
//                                                     }
       public void checkSurround(int x, int y)
       {
           ...
           {
                if((board[x-1][y] instanceof Terrain && ((Terrain)board[x-1][y]).getTerrainType() == Terrain.terrainType.land) ||
                   (board[x-1][y-1] instanceof Terrain && ((Terrain)board[x-1][y-1]).getTerrainType() == Terrain.terrainType.land) ||
                   (board[x][y+1] instanceof Terrain && ((Terrain)board[x][y+1]).getTerrainType() == Terrain.terrainType.land) ||    
                   (board[x][y-1] instanceof Terrain && ((Terrain)board[x][y-1]).getTerrainType() == Terrain.terrainType.land) ||
                   (board[x+1][y] instanceof Terrain && ((Terrain)board[x+1][y]).getTerrainType() == Terrain.terrainType.land) ||
                   (board[x+1][y-1] instanceof Terrain && ((Terrain)board[x+1][y-1]).getTerrainType() == Terrain.terrainType.land)
                  )
                    {
                        //return(false);
           ...
           {
               if((board[x-1][y+1] instanceof Terrain && ((Terrain)board[x-1][y+1]).getTerrainType() == Terrain.terrainType.land) ||
                  (board[x-1][y] instanceof Terrain && ((Terrain)board[x-1][y]).getTerrainType() == Terrain.terrainType.land) ||
                  (board[x][y+1] instanceof Terrain && ((Terrain)board[x][y+1]).getTerrainType() == Terrain.terrainType.land) ||    
                  (board[x][y-1] instanceof Terrain && ((Terrain)board[x][y-1]).getTerrainType() == Terrain.terrainType.land) ||
                  (board[x+1][y+1] instanceof Terrain && ((Terrain)board[x+1][y+1]).getTerrainType() == Terrain.terrainType.land) ||
	...
	{		
		...
		public void paintComponent(Graphics g)
		{
			...
			//fill in hexes
                            for (int i=0;i<BWIDTH;i++) {
                                    for (int j=0;j<BHEIGHT;j++) {					
                                            ...
                                            if (board[i][j] instanceof Piece)
                                                 hexmech.fillHex2(i,j,g2,((Piece)board[i][j]).getPieceType(),((Piece)board[i][j]).getValue(),((Piece)board[i][j]).getColor());
                        ...
                        {
                            g2.setColor(Color.RED);
                            hexmech.fillMenuHex1(27,3,g2,player1[0]);g2.setColor(Color.RED);
                            hexmech.fillMenuHex1(27,5,g2,player1[1]);g2.setColor(Color.RED);
                            hexmech.fillMenuHex1(27,7,g2,player1[2]);g2.setColor(Color.RED);
                            hexmech.fillMenuHex1(27,9,g2,player1[3]);g2.setColor(Color.RED);
                            hexmech.fillMenuHex1(27,11,g2,player1[4]);g2.setColor(Color.RED);
                         
                        }
                        if(playerTurn==2)
                        {
                            g2.setColor(Color.BLUE);
                            hexmech.fillMenuHex1(27,3,g2,player2[0]);g2.setColor(Color.BLUE);
                            hexmech.fillMenuHex1(27,5,g2,player2[1]);g2.setColor(Color.BLUE);
                            hexmech.fillMenuHex1(27,7,g2,player2[2]);g2.setColor(Color.BLUE);
                            hexmech.fillMenuHex1(27,9,g2,player2[3]);g2.setColor(Color.BLUE);
                            hexmech.fillMenuHex1(27,11,g2,player2[4]);g2.setColor(Color.BLUE);
                      
                        }
                        if(playerTurn==3)
                        {
                            g2.setColor(Color.GREEN);
                            hexmech.fillMenuHex1(27,3,g2,player3[0]);g2.setColor(Color.GREEN);
                            hexmech.fillMenuHex1(27,5,g2,player3[1]);g2.setColor(Color.GREEN);
                            hexmech.fillMenuHex1(27,7,g2,player3[2]);g2.setColor(Color.GREEN);
                            hexmech.fillMenuHex1(27,9,g2,player3[3]);g2.setColor(Color.GREEN);
                            hexmech.fillMenuHex1(27,11,g2,player3[4]);g2.setColor(Color.GREEN);
                         
                        }
                        if(playerTurn==4)
                        {
                            g2.setColor(Color.CYAN);
                            hexmech.fillMenuHex1(27,3,g2,player4[0]);g2.setColor(Color.CYAN);
                            hexmech.fillMenuHex1(27,5,g2,player4[1]);g2.setColor(Color.CYAN);
                            hexmech.fillMenuHex1(27,7,g2,player4[2]);g2.setColor(Color.CYAN);
                            hexmech.fillMenuHex1(27,9,g2,player4[3]);g2.setColor(Color.CYAN);
                            hexmech.fillMenuHex1(27,11,g2,player4[4]);g2.setColor(Color.CYAN);
                                                                ...
                                                                board[p.x][p.y]=new Piece(chosen);
                                                                 ...
                                                                 if(lastChosen > -1)
                                                                 {
                                                                    if(playerTurn==1)
                                                                    {
                                                                           ...
                                                                           //System.out.println(numPiecesPlayer1 + " NUMPIECESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS PLAYER1");
                                                                     ...
                                                                     if(playerTurn==2)
                                                                     {
                                                                        ...
                                                                        //System.out.println(numPiecesPlayer2 + " NUMPIECESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS PLAYER2");
